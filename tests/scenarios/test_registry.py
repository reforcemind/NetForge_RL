...
from netforge_rl.scenarios import (
    available,
    get_scenario_class,
    register,
)
...
@pytest.mark.parametrize('name,cls', [
    ...
    ('OT_STUXNET', OTStuxnetScenario),  # case-insensitive
])
...
def test_register_custom_scenario() -> None:
    class Custom(BaseScenario):
        ...
        def calculate_reward(self, *a, **k): return 0.0
        def check_termination(self, state): return {a: False for a in self.agents}
