...
The reference training script is [`benchmarks/rllib_rmappo.py`](https://github.com/reforcemind/NetForge_RL/blob/main/benchmarks/rllib_rmappo.py). It trains two shared LSTM policies (one red, one blue) with PPO on the legacy API stack.
