...
| 2 ext — full action port | ⚠️ 23/34 | see [ACTION_COVERAGE.md](ACTION_COVERAGE.md) |
...
| 8 grammar-constrained decoding | ✅ | anthropic_tool_schema / openai_tool_schema / vllm_grammar |
