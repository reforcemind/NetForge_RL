...
from .exploits import ExploitRemoteService, ExploitBlueKeep, ExploitEternalBlue, ExploitHTTP_RFI
...
__all__ = ['NetworkScan', 'DiscoverRemoteSystems', 'DiscoverNetworkServices', 'ExploitRemoteService', 'ExploitBlueKeep', 'ExploitEternalBlue', 'ExploitHTTP_RFI', 'PrivilegeEscalate', 'JuicyPotato', 'V4L2KernelExploit', 'Impact', 'KillProcess', 'ShareIntelligence', 'OverloadPLC', 'SpearPhishing', 'DumpLSASS', 'PassTheTicket']
